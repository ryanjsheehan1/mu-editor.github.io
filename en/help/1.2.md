  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        this!</strong></p>
        <p><a href="/en/tutorials/1.2" class="btn btn-primary"
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        look here.</p>
        <p><a href="/en/howto/1.2" class="btn btn-primary"
...
**If you think you've found a bug in Mu, congratulations! Please [follow the steps outlined here](/en/howto/1.2/bugs).**
