...
The current recommended version is Mu 1.1.0-beta-7. We advise people to update
...
<div class="media">
  ...
  <div class="media-body">
    ...
    <p><a href="https://github.com/mu-editor/mu/releases/download/1.1.0-beta.7/Mu.Editor.1.1.0b7.dmg" class="btn btn-primary" role="button">Download</a>
